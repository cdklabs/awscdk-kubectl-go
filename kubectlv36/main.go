// A Lambda Layer that contains kubectl v1.36
package kubectlv36
...
func init() {
	_jsii_.RegisterClass(
		"@aws-cdk/lambda-layer-kubectl-v36.KubectlV36Layer",
		reflect.TypeOf((*KubectlV36Layer)(nil)).Elem(),
		[]_jsii_.Member{
